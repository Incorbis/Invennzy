...
const Inventory = () => {
  ...
  const filteredLabs = labs.filter(lab => {
    const matchesSearch = lab.labNo.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const totalEquipment = labs.reduce((acc, lab) => ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Laboratory Inventory</h2>
          <p className="text-gray-600">Manage all college laboratory equipment and staff</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-gray-900">{totalEquipment.monitors}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-gray-900">{totalEquipment.projectors}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-gray-900">{totalEquipment.switchBoards}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-gray-900">{totalEquipment.fans}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-gray-900">{totalEquipment.wifi}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {filteredLabs.map((lab) => {
          ...
          return (
            <div key={lab.id} className="bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">{lab.labNo}</h3>
                    <p className="text-gray-600">{lab.labName}</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(lab.status)}`}>
                ...
                <div className="grid grid-cols-5 gap-2 mb-4">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-600">{lab.equipment.monitors}</p>
                  </div>
                  <div className="text-center">
                    <Projector className="mx-auto text-purple-500 mb-1" size={16} />
                    <p className="text-xs text-gray-600">{lab.equipment.projectors}</p>
                  </div>
                  <div className="text-center">
                    <Zap className="mx-auto text-yellow-500 mb-1" size={16} />
                    <p className="text-xs text-gray-600">{lab.equipment.switchBoards}</p>
                  </div>
                  <div className="text-center">
                    <Fan className="mx-auto text-green-500 mb-1" size={16} />
                    <p className="text-xs text-gray-600">{lab.equipment.fans}</p>
                  </div>
                  <div className="text-center">
                    <Wifi className="mx-auto text-indigo-500 mb-1" size={16} />
                    <p className="text-xs text-gray-600">{lab.equipment.wifi}</p>
                  </div>
                </div>
                ...
                <div className="border-t pt-4 space-y-2">
                  <div className="flex items-center text-sm">
                    ...
                    <span className="ml-1 text-gray-600">{lab.staff.incharge.name}</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <User className="mr-2 text-blue-600" size={14} />
                    <span className="font-medium">Assistant:</span>
                    <span className="ml-1 text-gray-600">{lab.staff.assistant.name}</span>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, labNo: e.target.value })}
              ...
              <div>
                <h4 className="text-lg font-medium text-gray-900 mb-4">Equipment Inventory</h4>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, monitors: parseInt(e.target.value) || 0 })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, projectors: parseInt(e.target.value) || 0 })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, switchBoards: parseInt(e.target.value) || 0 })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      type="number"
                      value={formData.fans}
                      onChange={(e) => setFormData({ ...formData, fans: parseInt(e.target.value) || 0 })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h5 className="text-md font-medium text-gray-800 mb-3">Lab In-charge</h5>
                  ...
                  <div>
                    <h5 className="text-md font-medium text-gray-800 mb-3">Lab Assistant</h5>
                    <div className="space-y-3">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Name</label>
                        <input
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">{viewingLab.capacity} students</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-600">Status</p>
                  <span className={`inline-flex px-2 py-1 text-sm font-semibold rounded-full ${getStatusColor(viewingLab.status)}`}>
                    {viewingLab.status}
                  </span>
                </div>
              </div>
              ...
              <div>
                <h4 className="text-lg font-medium text-gray-900 mb-4">Equipment Details</h4>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <Monitor className="mx-auto text-blue-500 mb-2" size={24} />
                    <p className="text-2xl font-bold text-gray-900">{viewingLab.equipment.monitors}</p>
                    <p className="text-sm text-gray-600">Monitors</p>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <Projector className="mx-auto text-purple-500 mb-2" size={24} />
                    <p className="text-2xl font-bold text-gray-900">{viewingLab.equipment.projectors}</p>
                    <p className="text-sm text-gray-600">Projectors</p>
                  </div>
                  <div className="text-center p-4 bg-yellow-50 rounded-lg">
                    <Zap className="mx-auto text-yellow-500 mb-2" size={24} />
                    <p className="text-2xl font-bold text-gray-900">{viewingLab.equipment.switchBoards}</p>
                    <p className="text-sm text-gray-600">Switch Boards</p>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <Fan className="mx-auto text-green-500 mb-2" size={24} />
                    <p className="text-2xl font-bold text-gray-900">{viewingLab.equipment.fans}</p>
                    <p className="text-sm text-gray-600">Fans</p>
                  </div>
                  <div className="text-center p-4 bg-indigo-50 rounded-lg">
                    <Wifi className="mx-auto text-indigo-500 mb-2" size={24} />
                    <p className="text-2xl font-bold text-gray-900">{viewingLab.equipment.wifi}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 bg-green-50 rounded-lg">
                    <div className="flex items-center mb-3">
                      ...
                      <h5 className="font-medium text-gray-900">Lab In-charge</h5>
                    </div>
                    <div className="space-y-2">
                      <p className="text-sm"><span className="font-medium">Name:</span> {viewingLab.staff.incharge.name}</p>
                      <p className="text-sm"><span className="font-medium">Email:</span> {viewingLab.staff.incharge.email}</p>
                      <p className="text-sm"><span className="font-medium">Phone:</span> {viewingLab.staff.incharge.phone}</p>
                    </div>
                  </div>
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <div className="flex items-center mb-3">
                      <User className="text-blue-600 mr-2" size={20} />
                      <h5 className="font-medium text-gray-900">Lab Assistant</h5>
                    </div>
                    <div className="space-y-2">
                      <p className="text-sm"><span className="font-medium">Name:</span> {viewingLab.staff.assistant.name}</p>
                      <p className="text-sm"><span className="font-medium">Email:</span> {viewingLab.staff.assistant.email}</p>
                      <p className="text-sm"><span className="font-medium">Phone:</span> {viewingLab.staff.assistant.phone}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center text-sm text-gray-500">
                Last updated: {new Date(viewingLab.lastUpdated).toLocaleString()}
              </div>
            </div>
          </div>
        </div>
